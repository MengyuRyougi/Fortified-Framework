...
namespace Fortified
{
    public class CompProperties_WeaponMod : CompProperties
    {
        public List<WeaponCategory> weaponCategories = new List<WeaponCategory>();
        public CompProperties_WeaponMod()
        {
            compClass = typeof(CompWeaponMod);
        }
    }
public class CompWeaponMod : ThingComp
    {
        ...
        public CompProperties_WeaponMod Props => (CompProperties_WeaponMod)props;
        ...
        public override string TransformLabel(string label)
        {
            if (styleable == null)
            {
                styleable = parent.TryGetComp<CompStyleable>();
            }

            if (styleable?.SourcePrecept?.Label != null)
            {
                return label;
            }
        ...
        private void Setup(bool fromSave)
        {
