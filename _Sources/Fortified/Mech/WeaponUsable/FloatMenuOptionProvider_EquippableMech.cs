...
namespace Fortified
{
    public class FloatMenuOptionProvider_EquippableMech : FloatMenuOptionProvider
    {
        ...
        protected override FloatMenuOption GetSingleOptionFor(Thing clickedThing, FloatMenuContext context)
        {
            ...
            if (EquipmentUtility.AlreadyBondedToWeapon(clickedThing, context.FirstSelectedPawn))
            {
                ...
                return RimWorld.FloatMenuUtility.DecoratePrioritizedTask(new FloatMenuOption(text, delegate
                {
